...
- [Barplots of blood meal ID by trap locations with/without WNV positive
  ...
  - [The following objects are masked from
    ‘package:stats’:](#the-following-objects-are-masked-from-packagestats)
  - [](#section)
  - [filter, lag](#filter-lag)
  - [The following objects are masked from
    ‘package:base’:](#the-following-objects-are-masked-from-packagebase)
  - [](#section-1)
  - [intersect, setdiff, setequal,
    union](#intersect-setdiff-setequal-union)
...
to human from biting. DNA extraction followed normal protocols to
...
<img src="Warm-up-mosquitoes-TEMPLATE-Noah-Blake-_files/figure-gfm/viremia-1.png" style="display: block; margin: auto auto auto 0;" />
...
<img src="Warm-up-mosquitoes-TEMPLATE-Noah-Blake-_files/figure-gfm/horiz-plot-1.png" style="display: block; margin: auto auto auto 0;" />
...
add citation for any refrences that we pick out
